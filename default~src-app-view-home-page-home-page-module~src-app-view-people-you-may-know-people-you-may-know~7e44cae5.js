(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~src-app-view-home-page-home-page-module~src-app-view-people-you-may-know-people-you-may-know~7e44cae5"],{
...
/***/ "ERkD":
/*!*********************************************************!*\
  !*** ./src/app/services/people-you-may-know.service.ts ***!
  \*********************************************************/
/*! exports provided: PeopleYouMayKnowService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PeopleYouMayKnowService", function() { return PeopleYouMayKnowService; });
...
class PeopleYouMayKnowService {
    ...
    peopleYouMAyKnow(skip) {
        return this.http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiUrl}/suggestedUsers?limit=10&skip=${skip}`);
    }
    getAllPeopleYouMAyKnow() {
        return this.http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiUrl}/suggestedUsers`);
    }
}
PeopleYouMayKnowService.ɵfac = function PeopleYouMayKnowService_Factory(t) { return new (t || PeopleYouMayKnowService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"])); };
PeopleYouMayKnowService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: PeopleYouMayKnowService, factory: PeopleYouMayKnowService.ɵfac, providedIn: 'root' });
...
/***/ "aTWD":
/*!********************************************************!*\
  !*** ./src/app/services/follow-or-unfollow.service.ts ***!
  \********************************************************/
/*! exports provided: FollowOrUnfollowService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FollowOrUnfollowService", function() { return FollowOrUnfollowService; });
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/environments/environment */ "AytR");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "tk/3");
...
class FollowOrUnfollowService {
    constructor(http) {
        this.http = http;
    }
    followOrUnFollow(id) {
        return this.http.post(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiUrl}/follow/${id}`, {});
    }
}
FollowOrUnfollowService.ɵfac = function FollowOrUnfollowService_Factory(t) { return new (t || FollowOrUnfollowService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"])); };
FollowOrUnfollowService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: FollowOrUnfollowService, factory: FollowOrUnfollowService.ɵfac, providedIn: 'root' });
...
//# sourceMappingURL=default~src-app-view-home-page-home-page-module~src-app-view-people-you-may-know-people-you-may-know~7e44cae5.js.map